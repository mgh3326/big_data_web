...
url2 = '&type=after&isActualPointWriteExecute=false&isMilegeSubscriptionAlready=false&isMileageSubscriptionReject=false&page='
url1 = "http://movie.naver.com/movie/bi/mi/pointWriteFormList.nhn?code="  # 네이버 영화 상세 리뷰 1
url2 = "&type=after&isActualPointWriteExecute=false&isMileageSubscriptionAlready=false&isMileageSubscriptionReject=false&page="  # 네이버 영화 상세 리뷰 2

hdr = {
    'User-Agent': 'Mozilla/5.0(Windows NT 6.3; WOW64) AppWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36',
...
def fectch_score_result(URL):
    ...
    for li in lis:
        ...
        spectator = li.find('div', class_='score_reple').find(
            'span').get_text()
        ...
        result_list.append({'score': score, 'review': review})
    return result_list
...
def fetch_reviews():
    ...
    while isLoop:
        ...
        print(URL)
        result_list = fectch_score_result(URL)
